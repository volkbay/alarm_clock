...
#define LCD_DATA0_PORT   PORTC     	// port for 4bit data bit 0 		//D5 poz:3 connector...[digits 0,1,...]
#define LCD_DATA1_PORT   PORTC     	// port for 4bit data bit 1 		//D6
#define LCD_DATA2_PORT   PORTC     	// port for 4bit data bit 2 		//D7
#define LCD_DATA3_PORT   PORTC     	// port for 4bit data bit 3 		//B0
